...
Đây là một dự án cho thấy ví dụ trực quan cơ bản về cách xây dựng, huấn luyện và đánh giá một mô hình trí tuệ nhân tạo để nhận dạng chữ số viết tay. Dự án này sử dụng bộ dữ liệu MNIST và thư viện PyTorch để thiết kế, huấn luyện và đánh giá mô hình.

## Mục tiêu dự án

-   Xây dựng một mô hình AI có khả năng nhận dạng chữ số viết tay (từ 0
    đến 9) với độ chính xác cao.
-   Tìm hiểu quy trình làm việc cơ bản của một dự án Deep Learning bằng
    PyTorch, bao gồm các giai đoạn sau: tải dữ liệu, tiền xử lý, thiết kế mô
